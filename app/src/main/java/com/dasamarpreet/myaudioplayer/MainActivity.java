    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.SourceCodeGitHub:
                ...
                StyleableToast.makeText(getApplicationContext(), urlTextGit, Toast.LENGTH_SHORT, R.style.customToast).show();
            ...
            case R.id.SourceCodeOneDrive:
                ...
                StyleableToast.makeText(getApplicationContext(), urlTextOne, Toast.LENGTH_SHORT, R.style.customToast).show();
                // Implicit Intent to open a web page
            ...
            case R.id.SourceCodeGoogleDrive:
                ...
                StyleableToast.makeText(getApplicationContext(), urlTextGoogle, Toast.LENGTH_SHORT, R.style.customToast).show();
                // Implicit Intent to open a web page
